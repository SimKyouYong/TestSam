...
@protocol CommonTableViewDelegate3 <NSObject>
@required
- (void)cancelButton;
- (void)submitButton:(NSString*)value name:(NSString*)name;
@end

@interface CommonTableView3 : UIView<UITableViewDelegate, UITableViewDataSource>{
...
@property (assign, nonatomic) id<CommonTableViewDelegate3> delegate;
